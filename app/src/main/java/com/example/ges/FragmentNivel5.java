 ...
 */
public class FragmentNivel5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fragment_nivel5, container, false);
    ...
    public void aEnhorabuena(){
        ...
        setFragment(new EnhorabuenaFragment());
